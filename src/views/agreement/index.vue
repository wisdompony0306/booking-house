...
<template>
    <div class="agreementBox">
        <!--S 协议内容-->
        <!-- <p class="desc"> 请确保 <strong class="strongColor">房源图片、小区、面积、厅室、朝向、楼层、租金、付款方式</strong>等信息与实际相符后，再交订金，保障您的合法权益
        不受侵害。</p>  -->
        <div class="desc">
                <div>
                    <strong>特别提示：</strong>
                    ...
                    <p> 2、  用户一旦勾选了“同意”《租房保证协议》或者实际接受或使用了58同城平台”租房交易保障服务”，就表示用户已接受了本协议的全部约定并愿意受其约束。请用户在勾选同意或使用58同城平台”租房交易保障服务”前务必仔细阅读本协议，<strong>充分理解各条款内容，特别是免除或者限制责任的条款、管辖与法律适用条款，如果用户不同意本协议或其中任何条款约定，应立即停止使用本协议项下的推广服务。</strong>如发生纠纷，用户不能以未经仔细阅读为由进行抗辩。
                    </p>
                ...
                <div>
                    ...
                    <p>
                        <strong>
                          8、  【确认入住及保证金转移支付】：承租人用户需按约定的入住时间入住并点击确认是否入住，如确实入住的需点击“确认入住”按钮，确认入住后，该标的房源将被下架处理，承租人用户点击确认后视为委托并同意58同城将保证金转移支付给出租人用户；如承租人用户申请退款的，需说明申请退款原因经58同城审核确认同意后退还；如承租人用户在约定的入住日期之日起7天内未申请退款的，承租人用户知悉并确认同意58同城有权视承租人用户默认确认已经入住，默认已经入住的，该标的房源将被下架处理，7天期满后58同城将自动将保证金转移给出租人用户。  
                        </strong>
                    </p>
                    <p>
...
<script>
    // import {DetailBottomBar} from '../../components/index';
    ...
    export default {
        ...
        created() {
            let _this=this;
            _this.infoId=_this.$getParameter('infoId');
