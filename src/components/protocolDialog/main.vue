<style rel="stylesheet/less" lang="less">
    ...
    @fontsize26: px2rem(26px);
    @fontsize42: px2rem(42px);
    .protocolDialogBox {
        position: fixed;
        top: 0;
        left: 0;
...
<template>
    <section class="protocolDialogBox" v-if="value">
        <div class="pdContent">
            <div class="pdcTitle">{{title}}</div>
            <div class="pdcDesc">
                {{desc}}
                <div>
                    <strong>特别提示：</strong>
                    <p>1、  本租房保证协议（以下称"本协议"）系用户（以下“用户”）与58同城网站（www.58.com）、无线站点（包括wap.58.com, m.58.com）及58同城移动应用软件（APP）（以下简称“58同城平台”或”乙方平台“）的所有者及其关联服务提供方共同签署。
                    </p>
                    <p> 2、  用户一旦勾选了“同意”《租房保证协议》或者实际接受或使用了58同城平台”租房交易保障服务”，就表示用户已接受了本协议的全部约定并愿意受其约束。请用户在勾选同意或使用58同城平台”租房交易保障服务”前务必仔细阅读本协议，充分理解各条款内容，特别是免除或者限制责任的条款、管辖与法律适用条款，如果用户不同意本协议或其中任何条款约定，应立即停止使用本协议项下的推广服务。如发生纠纷，用户不能以未经仔细阅读为由进行抗辩。
                    </p>
                    <p>3、  本服务协议内容包括协议正文及所有58同城平台已经发布的或将来可能发布的各类规则。所有规则为协议不可分割的组成部分，与本协议正文具有同等效力。本协议是《58同城使用协议》的有效组成部分，本协议未涉及的事项依照《58同城使用协议》处理。
                    </p>
                    <p>
                ...
                <div>
                    ...
                    <p>1、   【适用情形】：本协议适用于承租人用户在乙方平台页面查看了租房房源信息，经与出租人用户通过乙方平台提供的在线沟通方式进行了沟通确认或承租人用户与出租人用户先行进行了线下沟通、实际查看过标的房源、双方已经初步达成租赁意，同意通过乙方平台在线支付保证金以锁定该房源的情形。
                    </p>
                    <p>
                    ...
                    <p>
                        6、  【线下交易及出租人用户确认同意】：承租人用户缴纳保证金后，出租人用户需在24小时内确认是否同意出租给该承租人用户，如出租人用户同意出租的，则标的房源将被下架，租赁交易用户双方需线下签署租赁合同，当出租人用户点击同意出租的，则视为出租人用户与承租人用户已经签署了租赁书面合同达成租赁交易；如出租人用户不同意出租的，承租人用户需点击确认不同意出租或在24小时内未确认同意出租的，则该承租人的承租申请视为被拒绝。
                    </p>
                    <p>
                        7、  【约定入住时间】承租人用户需与出租人用户自行沟通协商具体入住日期，并按双方协商确定的入住日期在58同城平台页面填写确认，出租人用户在确认是否同意出租前亦需对承租人用户填写的入住日期审核，并根据审核的结果点击确认同意或不同意出租。
                    </p>
                    <p>
                        <strong>8、  【确认入住及保证金转移支付】：承租人用户需按约定的入住时间入住并点击确认是否入住，如确实入住的需点击“确认入住”按钮，承租人用户点击确认后视为委托并同意58同城将保证金转移支付给出租人用户；如承租人用户申请退款的，需说明申请退款原因经58同城审核确认同意后退还；如承租人用户在约定的入住日期之日起7天内未申请退款的，承租人用户知悉并确认同意58同城有权视承租人用户默认确认已经入住，7天到期后58同城将自动将保证金转移给出租人用户。
                        </strong>
                    </p>
                    <p>
            ...
            <div class="pdcButton" @click="handlerClose">{{buttonText}}</div>
        </div>
    </section>
</template>
