<style rel="stylesheet/less" lang="less">
    ...
    @fontsize50: px2rem(50px);
    @fontsize36: px2rem(36px);
    .ksBox {
        display: block;
        position: relative;
        overflow: hidden;
    ...
    export default{
        ...
        methods: {
            ...
            handlerMove: function (e) {
                ...
                _this.styleObject.transform = "translate(0," + _this.$px2rem(_Y) + ")";
            },
            handlerEnd: function (e) {
                ...
                _this.styleObject.transform = "translate(0," + _this.$px2rem(_this.Y) + ")";
